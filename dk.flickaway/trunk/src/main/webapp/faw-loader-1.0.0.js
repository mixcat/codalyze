...
$('<link rel="stylesheet" type="text/css" media="screen" href="stand-by-skin-default-1.0.0.css"/>').appendTo('head');

$(function() {
	$.ajax({url:'faw-skin-default-1.0.0.js', dataType:'script', cache:true});
	$.ajax({url:'faw-core-1.0.0.js', dataType:'script', cache:true});
	$.ajax({url:'jquery-plugin_stand-by-1.0.0.js', dataType:'script', cache:true});
